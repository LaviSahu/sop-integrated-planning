    ...
    <div class="stack">
      ...
      <section class="panel">
        ...
        <div class="leverpanel__banner">
          <span>⚠</span>
          <span><b>Not wired in this build.</b> Dragging a lever here changes nothing downstream — client-side recompute is a later build (SCOPE §2 row 7), not this one. Shown disabled rather than faked.</span>
        </div>
